...
?>
	...
	<footer id="colophon" class="site-footer" role="contentinfo">
		<div class="site-info">
			...
			<span class="sep"> | </span>
			<?php printf( __( 'Theme: %1$s by %2$s.', 'enormous' ), '<a href="'.esc_url( 'http://enwil.com/enormous' ).'" rel="designer">Enormous</a>', '<a href="'.esc_url('http://enwil.com/themes/enormous').'" rel="designer">Manish Suwal</a>' ); ?>
		</div><!-- .site-info -->
